...
from fetch_oferta import signIn, getClass, GuardarSecciones, By
import os

dpg.create_context()
id = ""
user_data = {}
fields = ["Clase", "Seccion", "Aula", "Profesor", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"]
class_names = []
...
def create_left_section():
    with dpg.group(horizontal=False):
        ...
        with dpg.group(horizontal=True):
            dpg.add_button(label="Select Times")
...
def save_callback(sender, data):
    ...
    class_code, class_times = dpg.get_item_user_data(sender)
